...
interface FavouriteIconAddedProps {
  className: string;
}

export const FavouriteIconAdded: React.FC<FavouriteIconAddedProps> = ({ className }) => {
  return (
    <svg
      version="1.0"
    ...
    >
      ...
      >
        <path
          d="M3300 11879 c-41 -4 -127 -13 -190 -19 -1345 -137 -2509 -1081 -2929
